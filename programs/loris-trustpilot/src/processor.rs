...
use crate::instruction::{CreateArgs, LorisTrustpilotInstruction};
...
impl Processor {
    pub fn process_instruction(
        ...
        match instruction {
            LorisTrustpilotInstruction::Create(args) => {
...
fn create(accounts: &[AccountInfo], args: CreateArgs) -> ProgramResult {
    ...
    if *system_program.key != system_program::id() {
        return Err(LorisTrustpilotError::InvalidSystemProgram.into());
    }
